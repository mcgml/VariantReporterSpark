 ...
 * Test
 */
public class GeneSparkFilterTest {
    ...
    public void pass() throws Exception {
        ...
        assertEquals(true, new GeneSparkFilter(genes, headers).call(variantContextBuilder.make()));
    }

    @Test
    public void failDoesNotContainGene() throws Exception {
        GenotypeBuilder genotypeBuilder = new GenotypeBuilder();
        HashSet<String> genes = new HashSet<String>() {{
            add("GENE");
        }};
        ...
        assertEquals(false, new GeneSparkFilter(genes, headers).call(variantContextBuilder.make()));
    }
