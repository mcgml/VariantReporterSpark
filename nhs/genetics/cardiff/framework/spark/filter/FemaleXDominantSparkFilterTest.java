 ...
 */
public class FemaleXDominantSparkFilterTest {
    ...
    public void call() throws Exception {
        ...
        FemaleXDominantSparkFilter femaleXDominantSparkFilter = new FemaleXDominantSparkFilter("sample1");
        assertEquals(true, femaleXDominantSparkFilter.call(variantContextBuilder.make()));
        ...
        femaleXDominantSparkFilter = new FemaleXDominantSparkFilter("sample1");
        assertEquals(false, femaleXDominantSparkFilter.call(variantContextBuilder.make()));
        ...
        variantContextBuilder.attribute("AC",5);
        variantContextBuilder.attribute("GNOMAD_2.0.1_Exome.AF_POPMAX", 0.0005);
        variantContextBuilder.attribute("GNOMAD_2.0.1_Genome_chrX.AF_POPMAX", 0.001);
