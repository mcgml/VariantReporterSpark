            ...
            if (sample.getAffection() == Affection.AFFECTED){
                ...
                if (sample.getMother() != null && sample.getFather() != null){
                    ...
                    WriteVariants.toTextFile(variants
                            ...
                            .filter(new FunctionalCodingImpactSparkFilter(sample.getID(), vcfHeaders.getVepHeaders()))
                            .collect(), sample.getID(), vcfHeaders.getVepHeaders(), GelFilterFramework.Workflow.DENOVO, preferredTranscripts, onlyPrintKnownRefSeq);
                    ...
                    WriteVariants.toTextFile(variants
                            ...
                            .filter(new FunctionalCodingImpactSparkFilter(sample.getID(), vcfHeaders.getVepHeaders()))
                            .collect(), sample.getID(), vcfHeaders.getVepHeaders(), GelFilterFramework.Workflow.UNIPARENTAL_ISODISOMY, preferredTranscripts, onlyPrintKnownRefSeq);
                }
                */
                ...
                WriteVariants.toTextFile(candidateCompoundHets
                                .filter(new GeneSparkFilter(GelFilterFramework.getVariantsWithMultipleGeneHits(
                        ...
                        sample.getID(), vcfHeaders.getVepHeaders(), GelFilterFramework.Workflow.COMPOUND_HETEROZYGOUS,preferredTranscripts, onlyPrintKnownRefSeq
                );
                    /*
                //simple recessive
                WriteVariants.toTextFile(variants
                        ...
                        .filter(new FunctionalCodingImpactSparkFilter(sample.getID(), vcfHeaders.getVepHeaders()))
                        .collect(), sample.getID(), vcfHeaders.getVepHeaders(), GelFilterFramework.Workflow.SIMPLE_RECESSIVE, preferredTranscripts, onlyPrintKnownRefSeq);
                ...
                WriteVariants.toTextFile(variants
                        ...
                        .filter(new FunctionalCodingImpactSparkFilter(sample.getID(), vcfHeaders.getVepHeaders()))
                        .collect(), sample.getID(), vcfHeaders.getVepHeaders(), GelFilterFramework.Workflow.AUTOSOMAL_DOMINANT, preferredTranscripts, onlyPrintKnownRefSeq);*/
